    ...
    <div className="xp-taskbar">
      ...
      <div className="xp-taskband">
        <button onClick={() => onOpen("internet-explorer")} style={{ width: 26, height: 26, border: "none", background: "none", cursor: "pointer", borderRadius: 2, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
          <img src="/assets/icons/InternetExplorer6.png" width="16" height="16" alt="" />
        </button>
        <button onClick={() => onOpen("explorer")} style={{ width: 26, height: 26, border: "none", background: "none", cursor: "pointer", borderRadius: 2, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
          <img src="/assets/icons/Explorer.png" width="16" height="16" alt="" />
        </button>
        ...
        <button onClick={() => onOpen("media-player")} style={{ width: 26, height: 26, border: "none", background: "none", cursor: "pointer", borderRadius: 2, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
          <img src="/assets/icons/WindowsMediaPlayer10.png" width="16" height="16" alt="" />
        </button>
      </div>
      <div className="xp-taskbar-tasks">
        {running.map((win) => (
          ...
          >
            {win.icon && <img src={`/assets/icons/${win.icon}`} alt="" width="14" height="14" style={{ flexShrink: 0 }} />}
            <span style={{ overflow: "hidden", textOverflow: "ellipsis" }}>{win.title}</span>
          </button>
        ))}
      </div>
      <div className="xp-tray">
        <img src="/assets/icons/SafelyRemoveHardware.png" alt="" className="xp-tray-icon" title="Safely Remove Hardware" />
        <img src="/assets/icons/NetworkConnection.png" alt="" className="xp-tray-icon" title="Network Status" />
        <img src="/assets/icons/Volume.png" alt="" className="xp-tray-icon" onClick={() => onOpen("volume")} title="Volume" />
        <img src="/assets/icons/TaskManager.png" alt="" className="xp-tray-icon" title="Task Manager" />
