  ...
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", fontFamily: "Tahoma, sans-serif", fontSize: 11, background: "#D4D0C8" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 2, padding: 2, borderBottom: "1px solid #808080", background: "#ECE9D8" }}>
        <button style={{ ...navBtnStyle }} onClick={goBack} disabled={historyIdx <= 0} title="Back"><img src={assetUrl("assets/icons/Back.png")} width="16" height="16" alt="" /></button>
        <button style={{ ...navBtnStyle }} onClick={goForward} disabled={historyIdx >= history.length - 1} title="Forward"><img src={assetUrl("assets/icons/Forward.png")} width="16" height="16" alt="" /></button>
        <button style={{ ...navBtnStyle }} onClick={refresh} title="Refresh">Ref</button>
        <button style={{ ...navBtnStyle }} onClick={stop} title="Stop"><img src={assetUrl("assets/icons/Stop.png")} width="16" height="16" alt="" /></button>
